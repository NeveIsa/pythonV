...
be found in my M.Tech thesis which can be accessed at [Thesis](http://nitrjindal.in/static/Thesis.pdf)
Project Website (Authentication Required – Guest credentials for demo available on request) [site](http://nitrjindal.in)
